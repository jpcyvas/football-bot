...
const footballApiUrlSchedule = 'https://cdn.espn.com/core/nfl/schedule?xhr=1&year=2026&week={WEEK}';
...
function getCurrentNFLWeek(today = new Date()) {
  const seasonStart = new Date('2026-09-09'); // NFL 2026 season start date
