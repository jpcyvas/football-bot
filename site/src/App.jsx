...
export default function App() {
  ...
  return (
    <div className="p-4 bg-gray-100">
      ...
      <h1 className='text-2xl p-4'>Family Fantasy Football</h1>

        <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-6 ">
          <div >
            <DataTable value={stats}  header="Winners Leaderboard" sortField="wins" sortOrder={-1} onRowSelect={onRowSelect} selectionMode="single" className="shadow-md"> 
              <Column field="name" header="Name"></Column>
              <Column field="wins" header="Wins"></Column>
            </DataTable>
          </div>
          <div c>
            <DataTable value={stats} header="Losers Leaderboard" sortField="losses" sortOrder={-1} onRowSelect={onRowSelect} selectionMode="single" className="shadow-md">
              <Column field="name" header="Name"></Column>
      ...
      <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2  gap-4">
        ...
        <div key={index} >
            <Fieldset legend={player.name} className='shadow-md bg-blue-500 p-2' >
      ...
      <Dialog header={currentPlayer?.name || ''} visible={dialogVisible}  onHide={() => {if (!dialogVisible) return; setDialogVisible(false); }} >
